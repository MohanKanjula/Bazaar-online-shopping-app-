...
public class buypage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(buypage.this,android.R.layout.simple_list_item_1,arraylist);
            ...
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                   ...
                   productslist.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                       ...
                       public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                           ...
                           Toast.makeText(buypage.this,"hello bro",Toast.LENGTH_SHORT).show();
                           ...
                           Intent in = new Intent(buypage.this,agreementpage.class);
                           in.putExtra("Id1",str);
